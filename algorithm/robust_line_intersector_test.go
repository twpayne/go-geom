...
func TestRobustLineIntersectionPointOnLine(t *testing.T) {
	exectuteLineIntersectionPointOnLineTest(t, algorithm.RobustLineIntersector{})
}

func TestRobustLineIntersectionLines(t *testing.T) {
	executeLineIntersectionLinesTest(t, algorithm.RobustLineIntersector{})
	...
	for i, tc := range []LineIntersectsLinesTestData{
		{
			...
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{1, 1}}),
		},
		{
		...
		},
		{
			...
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{5, 5}}),
		},
		{
		...
		},
		{
			...
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{2087536.6062609926, 1187900.560566967}}),
		},
	} {
		doLineIntersectsLineTest(t, algorithm.RobustLineIntersector{}, i, tc)
	}
}
...
func exectuteLineIntersectionPointOnLineTest(t *testing.T, intersectionStrategy algorithm.LineIntersectionStrategy) {
	for i, tc := range []PointOnLineTestData{
		...
		intersector := algorithm.LineIntersector{Layout: geom.XY, Strategy: intersectionStrategy}
...
type LineIntersectsLinesTestData struct {
	...
	Result         algorithm.LineOnLineIntersection
}

func executeLineIntersectionLinesTest(t *testing.T, intersectionStrategy algorithm.LineIntersectionStrategy) {
	for i, tc := range []LineIntersectsLinesTestData{
		{
			Desc: "A perfect X at 0",
			P1:   geom.Coord{-1, 0}, P2: geom.Coord{1, 0}, P3: geom.Coord{0, -1}, P4: geom.Coord{0, 1},
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{0, 0}}),
		},
		{
			Desc: "A perfect X at 15, 15",
			P1:   geom.Coord{10, 10}, P2: geom.Coord{20, 20}, P3: geom.Coord{10, 20}, P4: geom.Coord{20, 10},
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{15, 15}}),
		},
		{
			Desc: "Same coordinates opposite vectors",
			P1:   geom.Coord{10, 10}, P2: geom.Coord{20, 20}, P3: geom.Coord{20, 20}, P4: geom.Coord{10, 10},
			Result: algorithm.NewLineOnLineIntersection(algorithm.COLLINEAR_INTERSECTION, []geom.Coord{geom.Coord{10, 10}, geom.Coord{20, 20}}),
		},
		{
			...
			Result: algorithm.NewLineOnLineIntersection(algorithm.NO_INTERSECTION, []geom.Coord{}),
		},
		{
		...
		},
		{
			...
			Result: algorithm.NewLineOnLineIntersection(algorithm.POINT_INTERSECTION, []geom.Coord{geom.Coord{4, 4}}),
		},
		{
...
func doLineIntersectsLineTest(t *testing.T, intersectionStrategy algorithm.LineIntersectionStrategy, i int, tc LineIntersectsLinesTestData) {
	defer func() {
