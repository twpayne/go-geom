...
var lineOnLineIntersectionTestData = []lineIntersectsLinesTestData{
	{
		...
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{0, 0}}),
	},
	{
		Desc: "A perfect X at 15, 15",
		P1:   geom.Coord{10, 10}, P2: geom.Coord{20, 20}, P3: geom.Coord{10, 20}, P4: geom.Coord{20, 10},
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{15, 15}}),
	},
	{
		Desc: "Same coordinates opposite vectors",
		P1:   geom.Coord{10, 10}, P2: geom.Coord{20, 20}, P3: geom.Coord{20, 20}, P4: geom.Coord{10, 10},
		Result: lineintersection.NewResult(lineintersection.CollinearIntersection, []geom.Coord{geom.Coord{10, 10}, geom.Coord{20, 20}}),
	},
	{
	...
	},
	{
		...
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{5, 5}}),
	},
	{
		...
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{1, 1}}),
	},
	{
		...
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{4, 4}}),
	},
	{
...
var robustLineOnLineIntersectionData = append(lineOnLineIntersectionTestData, []lineIntersectsLinesTestData{
	...
	},
	{
		...
		Result: lineintersection.NewResult(lineintersection.PointIntersection, []geom.Coord{geom.Coord{2087536.6062609926, 1187900.560566967}}),
	},
}...)
