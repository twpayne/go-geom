...
/*
Compute the intersection of a point on a line.  Naturally there may not be an intersection, in this case NO intersection will be returned.

This method updates the internal start of this object with the intersection information.
*/
func (li NonRobustLineIntersector) computeIntersection(p, lineEndpoint1, lineEndpoint2 geom.Coord) (isProper bool, result Intersection) {
	...
	dist := li.rParameter(lineEndpoint1, lineEndpoint2, p)
